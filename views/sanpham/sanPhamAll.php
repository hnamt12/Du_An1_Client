            ...
            <div class="page-content-inner enable-page-sidebar">
                <div class="container-fluid">
                    <div class="row shop-sidebar pt--45 pt-md--35 pt-sm--20 pb--60 pb-md--50 pb-sm--40">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <div class="product-info text-center">
                                                    <h3 class="product-title">
                                                        <a href="<?=BASE_URL?>?act=sanpham_detail">Limited edition v-neck
                                                            t-shirt</a>
                                                    </h3>
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb--40 mb-md--30">
                                        <div class="airi-product">
                                            <div class="product-inner">
                                                <figure class="product-image">
                                                    <div class="product-image--holder">
                                                        <a href="<?=BASE_URL?>?act=sanpham_detail">
                                                ...
                                                <div class="product-info text-center">
                                                    <h3 class="product-title">
                                                        <a href="<?=BASE_URL?>?act=detail&id">Hig-Rise Skinny Jean</a>
                                                    </h3>
                        ...
                        <!-- Thanh slidebar filler bên trái tìm kiếm các sản phâm  -->
