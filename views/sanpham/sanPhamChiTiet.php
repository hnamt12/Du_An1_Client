                ...
                <div class="col-md-6 product-main-image">
                    <div class="product-image">
                        ...
                        <div class="product-gallery vertical-slide-nav">
                            ...
                            <!-- Ảnh chính sản phẩm  -->
                            <div class="product-gallery__large-image imgShow">
                                    ...
                                    <div class="product-gallery__wrapper">
                                        ...
                                        <div class="airi-element-carousel main-slider product-gallery__full-image image-popup"
                                            ...
                                            <figure class="product-gallery__image zoom">
                                                <img src="uploads/sanpham3.jpg" alt="Product">
                                            </figure>
                                            <figure class="product-gallery__image zoom">
                            ...
                            <!-- hình ảnh sản phẩmr 2  -->


                        </div>
                        <div class="product-gallery__thumb--image">

                            <div class="airi-element-carousel nav-slider" data-slick-options='{
            "slidesToShow": 3,
            "slidesToScroll": 1,
            "vertical": false,
            "swipe": true,
            ...
            },
            {
                ...
                "settings": {
                    ...
                    "verticalSwiping": false
                                ...
                                <figure class="product-gallery__thumb--single imgShow3">
                                    <img src="uploads/sanpham1.jpg" alt="Products">
                                </figure>
                ...
                <div class="col-md-6 product-main-details mt--40 mt-md--10 mt-sm--30">
                    ...
                    <div class="product-summary">
                        ...
                        <form action="#" class="form--action mb--30 mb-sm--20">
                            <div class="flex flex-column" id="flex22">
                                <h3> Màu Sắc</h3>
                                    ...
                                    <ul class="review__list">
                                        <li class="review__item">
                                            <div class="review__container">
                                                <img src="assets/img/others/comment-icon-2.jpg" alt="Review Avatar"
                                        ...
                                        <figure class="product-image">
                                            <div class="product-image--holder">
                                                <a href="product-details.html">
                                                    <img src="assets/img/products/prod-8-2.jpg" alt="Product Image"
                                                        class="primary-image">
                                                    <img src="assets/img/products/prod-8-1.jpg" alt="Product Image"
                                ...
                                <div class="airi-product">
                                    <div class="product-inner">
                                        <figure class="product-image">
                                            <div class="product-image--holder">
                                                <a href="product-details.html">
                                                    <img src="assets/img/products/prod-3-2.jpg" alt="Product Image"
                                                        class="primary-image">
                                                    <img src="assets/img/products/prod-3-3.jpg" alt="Product Image"
                                                        class="secondary-image">
                                                </a>
                                            </div>
                                            <div class="airi-product-action">
                                ...
                                <div class="airi-product">
                                    <div class="product-inner">
                                        <figure class="product-image">
                                            <div class="product-image--holder">
                                                <a href="product-details.html">
                                                    <img src="assets/img/products/prod-1-1.jpg" alt="Product Image"
                                                        class="primary-image">
                                                    <img src="assets/img/products/prod-1-4.jpg" alt="Product Image"
                                                        class="secondary-image">
                                                </a>
                                            </div>
                                            <div class="airi-product-action">
                                ...
                                <div class="airi-product">
                                    <div class="product-inner">
                                        <figure class="product-image">
                                            <div class="product-image--holder">
                                                <a href="product-details.html">
                                                    <img src="assets/img/products/prod-20-1.jpg" alt="Product Image"
                                                        class="primary-image">
                                                    <img src="assets/img/products/prod-20-2.jpg" alt="Product Image"
                                                        class="secondary-image">
                                                </a>
                                            </div>
                                            <div class="airi-product-action">
